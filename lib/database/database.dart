...
class Database {
  ...
  static List<Map> comingsoonlist = [
    {
      "coming_img": Imageconstant.comingsoon_3,
      "title": "Castle & Castle",
      "text": [
        "Steamy",
        "Soapy",
    ...
    {
      "coming_img": Imageconstant.comingsoon_4,
      "title": "Tiny Pretty Things",
      "text": ["Steamy", "Soapy", "Slow Burn", "Suspenseful", "Teen", "Mystery"]
    },
    {
      "coming_img": Imageconstant.comingsoon_5,
      "title": "Tiny Pretty Things",
      "text": [
        "Steamy",
        "Soapy",
  ...
  static List<Map> newarrivallist = [
    {
      "newarrival_img": Imageconstant.comingsoon_1,
      "title": "El Chapo",
      "date": "Nov 6"
    },
    {
      "newarrival_img": Imageconstant.comingsoon_2,
  ...
  static List<Map> homescreenlist = [
    {
      ...
      "Images": Database.homescreenimagelist
    },
    {
