          ...
          SingleChildScrollView(scrollDirection: Axis.horizontal,
            child: Row(children: List.generate(
              mylist.length, (index) =>    Row(children: [
                     ...
                     SizedBox(width: 5,),
                    //     Text("Soapy",style: TextStyle(fontSize: 11,fontWeight: FontWeight.w600,color: ColorConstant.primarywhite),),
                    //  SizedBox(width: 5,),
                    //  CircleAvatar(backgroundColor: ColorConstant.primarywhite.withOpacity(.69),radius: 2,),
                    //  SizedBox(width: 5,),
                    //       Text("Slow Burn",style: TextStyle(fontSize: 11,fontWeight: FontWeight.w600,color: ColorConstant.primarywhite),),
                    //  SizedBox(width: 5,),
                    //  CircleAvatar(backgroundColor: ColorConstant.primarywhite.withOpacity(.69),radius: 2,),
                    //  SizedBox(width: 5,),
                    //       Text("Suspenseful",style: TextStyle(fontSize: 11,fontWeight: FontWeight.w600,color: ColorConstant.primarywhite),),
                    //  SizedBox(width: 5,),
                    //  CircleAvatar(backgroundColor: ColorConstant.primarywhite.withOpacity(.69),radius: 2,),
                    //  SizedBox(width: 5,),
                    //       Text("Teen",style: TextStyle(fontSize: 11,fontWeight: FontWeight.w600,color: ColorConstant.primarywhite),),
                    //  SizedBox(width: 5,),
                    //  CircleAvatar(backgroundColor: ColorConstant.primarywhite.withOpacity(.69),radius: 2,),
                    //  SizedBox(width: 5,),
                    //       Text("Mystery",style: TextStyle(fontSize: 11,fontWeight: FontWeight.w600,color: ColorConstant.primarywhite),),
                    //  SizedBox(width: 5,),
                    //  CircleAvatar(backgroundColor: ColorConstant.primarywhite.withOpacity(.69),radius: 2,),
                    //  SizedBox(width: 5,),
                   ],))
